...
class UpBlock(nn.Module):
    ...
    def __init__(self, in_channels1, in_channels2, out_channels, dropout_p,
                bilinear=True, kernel_size=3, padding=1):
        ...
        self.conv = ConvBlock(in_channels2 * 2, out_channels, dropout_p, kernel_size, padding)
...
class Decoder(nn.Module):
    def __init__(self, params, kernel_size=3, padding=1):
        ...
        self.up1 = UpBlock(
            self.ft_chns[4], self.ft_chns[3], self.ft_chns[3], dropout_p=0.0, kernel_size=kernel_size, padding=padding)
        self.up2 = UpBlock(
            self.ft_chns[3], self.ft_chns[2], self.ft_chns[2], dropout_p=0.0, kernel_size=kernel_size, padding=padding)
        self.up3 = UpBlock(
            self.ft_chns[2], self.ft_chns[1], self.ft_chns[1], dropout_p=0.0, kernel_size=kernel_size, padding=padding)
        self.up4 = UpBlock(
            self.ft_chns[1], self.ft_chns[0], self.ft_chns[0], dropout_p=0.0, kernel_size=kernel_size, padding=padding)
...
class UNet(nn.Module):
    def __init__(self, in_chns, class_num):
        ...
        self.decoder = Decoder(params,7,3)
...
class UNet_Multihead_Reception(nn.Module):
    def __init__(self, in_chns, class_num, train_mode=True):
        super(UNet_Multihead_Reception, self).__init__()
        ...
        self.decoder2 = Decoder(params,5,2)
        self.decoder3 = Decoder(params,7,3)
    ...
    def forward(self, x):
        ...
        if self.mode:
            return output1, output2, output3, feature
        else:
            return output1
